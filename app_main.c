...
void power_app_run(ExampleGuiContext *context)
{
    ...
    for (bool is_running = true; is_running;)
    {
        ...
        {
            furi_hal_power_set_battery_charge_voltage_limit(10);
...
void power_app_draw_callback(Canvas *canvas, void *ctx)
{
    ...
    canvas_draw_str_aligned(canvas,8*4,30+8+8,AlignLeft,AlignBottom,"(>=10%)");
    canvas_draw_str_aligned(canvas, 0, 30+8+8+8, AlignLeft, AlignBottom, "Right: power off");
